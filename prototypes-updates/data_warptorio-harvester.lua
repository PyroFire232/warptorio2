...
local t = ExtendDataCopy("accumulator", "warptorio-teleporter-0", {
	name = "warptorio-harvestportal-0",
	minable = { mining_time = 5, result = "warptorio-harvestportal-1" },
	energy_source = { buffer_capacity = "5MJ", input_flow_limit = "500kW", output_flow_limit = "500kW" }
}, false)

local t = ExtendDataCopy("accumulator", "warptorio-teleporter-0", {
	name = "warptorio-harvestportal-1",
	minable = { mining_time = 5, result = "warptorio-harvestportal-1" },
	energy_source = { buffer_capacity = "10MJ", input_flow_limit = "500MW", output_flow_limit = "500MW" }
}, true)
local t = ExtendDataCopy("accumulator", "warptorio-harvestportal-1",
	{ name = "warptorio-harvestportal-2", energy_source = { buffer_capacity = "50MJ", input_flow_limit = "1GW", output_flow_limit = "1GW" } },
	false)
local t = ExtendDataCopy("accumulator", "warptorio-harvestportal-1",
	{ name = "warptorio-harvestportal-3", energy_source = { buffer_capacity = "100MJ", input_flow_limit = "2GW", output_flow_limit = "2GW" } },
	false)
local t = ExtendDataCopy("accumulator", "warptorio-harvestportal-1",
	{ name = "warptorio-harvestportal-4", energy_source = { buffer_capacity = "500MJ", input_flow_limit = "5GW", output_flow_limit = "5GW" } },
	false)
local t = ExtendDataCopy("accumulator", "warptorio-harvestportal-1",
	{ name = "warptorio-harvestportal-5", energy_source = { buffer_capacity = "1GJ", input_flow_limit = "20GW", output_flow_limit = "20GW" } },
	false)
...
local function makePortal(suffix, visible, sprite, size, vorder, btag)
	...
	return {
		...
		},
		{
			...
			name = name,
			localised_name = localised_name,
			icons = { { icon = "__base__/graphics/icons/lab.png", tint = rtint, }, { icon = "__base__/graphics/icons/fast-underground-belt.png", scale = 0.3, shift = { shift_side * 8, 0 } } },
			icon_size = 64,
			flags = item_flags,
			subgroup = "storage",
			order = (vorder or "a-a"),
